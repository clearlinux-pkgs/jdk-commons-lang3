...
License  : Apache-2.0
Requires: jdk-commons-lang3-data
...
%package data
Summary: data components for the jdk-commons-lang3 package.
Group: Data

%description data
data components for the jdk-commons-lang3 package.


%prep
%setup -q -n commons-lang-LANG_3_4
%patch1 -p1

python3 /usr/share/java-utils/mvn_file.py : apache-commons-lang3 commons-lang3

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n apache-commons-lang3 -d %{buildroot}
...
/usr/share/maven-metadata/apache-commons-lang3.xml
/usr/share/maven-poms/apache-commons-lang3.pom
/usr/share/maven-poms/commons-lang3.pom
